...
class Writer
{
        ...
        f = function(e) {
            ...
            switch(e) {
                ...
                case ECommented(s, b, t, e):
					stats.push("--------AAA catch comments before else blocks \n" + s + "\n" + 
						[
							"block: " + b
							+ "tail: " + t
						].join("\n") + "\n");
    ...
    {
		//stats.push("comment |||" + s + "||| " + (lineIsDirty ? "(D)" : "") + "\n");
		
		if (s.indexOf("qwer ent") != -1)
		{
			stats.push("lineIsDirty: " + lineIsDirty + "\n");
			stats.push("lvl: " + lvl + "\n");
			stats.push("context: " + [for (k in context.keys()) k].join(", ") + "\n");
		}
